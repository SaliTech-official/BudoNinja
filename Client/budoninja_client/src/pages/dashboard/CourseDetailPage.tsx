...
import { Calendar, MapPin, Hourglass, Info, CalendarDays, User } from "lucide-react";
            ...
            <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-10">
                    <div className='flex flex-col gap-6'>
                        ...
                        <h2 className='text-3xl text-neutral-900'>دوره مربیگری سطح 1</h2>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <InfoCard IconComponent={Calendar} title="تاریخ برگزاری" text="از 23 آبان تا 23 آذر"/>
                        <InfoCard IconComponent={MapPin} title="مکان برگزاری" text="اصفهان، باشگاه تختی"/>
                        <InfoCard IconComponent={Hourglass} title="مهلت ثبت نام" text="۱۳ آبان ۱۴۰۳"/>
                        <InfoCard IconComponent={Info} title="نوع کلاس" text="عمومی"/>
                        <InfoCard IconComponent={User} title="نام استاد" text="خواجه"/>
                        <InfoCard IconComponent={CalendarDays} title="تعداد جلسات" text="12"/>
                    </div>
                </div>
                <div className="flex flex-col gap-4">
                    <h4 className="text-xl text-neutral-900">توضیحات و قوانین کلاس</h4>
                    <div className="flex flex-col gap-6 text-base text-neutral-700">
                        <p>
                            این دوره با هدف ارتقای مهارت‌های فنی و افزایش آمادگی شرکت‌کنندگان برگزار می‌شود.

                            در طول کلاس، مباحث به‌صورت تئوری و عملی آموزش داده شده و تمرین‌های کاربردی برای تثبیت یادگیری ارائه خواهد شد.

                            سطح دوره به‌گونه‌ای طراحی شده که افراد با دانش پایه نیز بتوانند شرکت کنند و در پایان دوره به تسلط قابل قبولی برسند.

                            جلسات به‌صورت منظم و طبق برنامه زمان‌بندی اعلام‌شده برگزار می‌شوند.
                        </p>
                        <div>
                            <p>- تصویر کارت ملی</p>
                            <p>- یک قطعه عکس پرسنلی</p>
                            <p>- تکمیل فرم ثبت‌نام</p>
                            <p>- در صورت نیاز: گواهی پزشکی یا معرفی‌نامه (برای دوره‌های تخصصی)</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="bg-neutral-50 w-full lg:max-w-90 h-fit rounded-[16px] p-6 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.06)]">
            <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-2 items-center">
                    ...
                    <p className="text-primary-600 text-2xl font-bold">۳,۳۵۰,۰۰۰ تومان</p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="text-sm text-neutral-600 font-semibold">قوانین کلاس را می‌پذیرم</p>
                    </div>
                </div>
                <div className="flex flex-col gap-3 items-center">
                    <Button size="lg" className="w-full">پرداخت و نهایی کردن</Button>
                    <p className="text-xs text-primary-400 font-semibold">۲ روز و ۱۰ ساعت باقی‌مانده تا شروع کلاس</p>
                </div>
            </div>
        </div>
    </div>
