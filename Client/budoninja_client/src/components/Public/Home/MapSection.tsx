...
export function MapSection() {
  ...
  return (
    <section className="py-24" style={{ backgroundColor: 'var(--color-neutral-100)' }}>
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="order-last lg:order-first rounded-2xl bg-neutral-800 p-4 shadow-lg min-h-[600px]">
          <IranMap 
        ...
        <div className="order-first lg:order-last rounded-2xl bg-white p-8 shadow-lg min-h-[600px] flex flex-col justify-center">
          {displayData ? (
