...
urlpatterns = [
    ...
    path("user_dashboard/", views.UserDashbordInfoView.as_view()),
    path("user_membership/", views.GetMemberShipInfoView.as_view()),
    ...
    path("check_user/", views.UserExistenceView.as_view()),
